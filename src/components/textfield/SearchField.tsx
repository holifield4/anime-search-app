...
const SearchField = (props: React.InputHTMLAttributes<HTMLInputElement> ) => {
  return (
    <div className="relative text-ios-label-secondary">
      <div className="w-64 focus-within:w-80 transition-all duration-300">
        <input
          {...props}
          placeholder="Search"
          className="input shadow-sm dark:shadow-dark-label-2 focus:border-2 bg-ios-primary border-ios-secondary pl-5 pr-10 py-3 rounded-xl w-full outline-none h-12"
          name="search"
          aria-label="Search"
        />
